...
[TestFixture]
public class Arithmetic : ServerTestBase
{
        ...
        ArithmeticOperatorTestCase arithmeticOperatorTestCase)
    {
        ...
        var dataType = (DecimalDatatype)variable.Datatype;
        
        var expected = Math.Round(unrounded, digits: dataType.DecimalPlaces, MidpointRounding.ToNegativeInfinity);
        
        var tolerance = 1.0 / dataType.Scale;
