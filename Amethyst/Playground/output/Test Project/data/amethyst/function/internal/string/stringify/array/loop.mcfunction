...
data modify storage amethyst:internal string.stringify._stack[-1]._ set from storage amethyst:internal string.stringify._stack[-2]._[0]
function amethyst:internal/string/stringify/loop
data remove storage amethyst:internal string.stringify._stack[-1]._[0]
...
execute if data storage amethyst:internal string.stringify._stack[-1]._[] run function amethyst:internal/string/stringify/array/next