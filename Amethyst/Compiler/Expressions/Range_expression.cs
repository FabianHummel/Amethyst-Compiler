...
public partial class Compiler
{
    ...
    {
        private readonly AmethystParser.Range_expressionContext _context;
        private readonly bool _allowDecimals;

        public RangeExpressionResult(AmethystParser.Range_expressionContext context, bool allowDecimals)
        {
            _context = context;
    ...
    public RangeExpressionResult VisitRange_expression(AmethystParser.Range_expressionContext context, bool allowDecimals)
    {
