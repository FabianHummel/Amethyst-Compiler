...
public abstract class AbstractAmethystValue : AbstractValue
{
    ...
    {
        // TODO: I don't like this being here. Find a way to move this to the specific type (e.g. AbstractString). USE DOUBLE DISPATCH!! (Separate function where the RHS is defined and the LHS is not
        // and calls these functions instead.)
