...
public abstract partial class NumericBase : RuntimeValue
{
    ...
    public new RuntimeValue EnsureInStorage()
    {
        var location = NextFreeLocation();
        
        AddCode($"execute store result storage amethyst: {location} {DataType.StorageModifier} run scoreboard players get {Location} amethyst");
